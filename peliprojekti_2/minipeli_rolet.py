...
#Varmista, että käyttäjä valitsee kirjoitusarvon ja käyttää sitä panostaakseen niin paljon kuin käyttäjällä on mahdollisuus

            for i in range(betCounter):
                userType = input("ok "+playerName+" select your numbers: \n \nor you can choose black and red \n \nor even or odd numbers \n \nfor betting type bet: ")
